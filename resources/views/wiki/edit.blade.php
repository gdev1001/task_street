                    ...
                    <div class="tabbing"> 
                     ...
                     @if(isset($page->id))
                      ...
                      <div class="tab-content tab_editor">						
						...
						<form class="form-horizontal" action={{url("/".$name."/wiki/".$page->id)}} method="post">
							{{ csrf_field() }}
							...
							<div id="editor" >
								...
								<textarea id="summernote" class="p_sec1a">{{ (\Illuminate\Support\Facades\Input::has('raw') ? \Illuminate\Support\Facades\Input::get('raw') : $page->raw) }}</textarea>
