    	...
    	<nav class="navbar container">
          <figure class="row">
            ...
            <figcaption class="search_cover navbar-collapse">
            	<a class="btn" data-toggle="modal" href="/{!!$name!!}/wiki" class="pic_box" data-target="#ajaxModal" style="float: left; margin-right: 10px;" data-backdrop = "true" onClick="makeMainBlur()">Menu</a>
        	...
        	<article class="container">
            	<figure>
                    ...
                    <h1 class="text-center">
                        @if($isCompany)
                            <a class="navbar-brand" href="/client/manage" style="vertical-align: middle; line-height: 50px;margin-left: 50px;"> 
                    ...
                    <div class="tabbing"> 
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        @if(isset($can_edit_page) && $page->lock == 0)
							<li role="presentation"><a href="/{{$name}}/wiki/{{ $page->id }}/edit" ><i class="edit"></i>edit</a></li>
                            <!--
                      	...
                      	<div role="tabpanel" class="tab-pane active" id="add">
                            ...
                            <div class="tab_list">
									...
									@else
										...
										<a href="/{{$name}}/wiki/create" class="btn btn-success">Create Page</a>
									@endif
									@if(isset($page->id) && $page->children()->count() > 0)
										...
										<ul>
											@foreach($page->children()->get() as $child)
												<li><a href="{{url('/'.$name.'/wiki/'.$child->id) }}">{{ $child->title }}</a></li>
											@endforeach
										</ul>
									@endif
...
<!-- /.modal -->
    ...
    <script type="text/javascript">
        function makeMainBlur()   {
            jQuery("main.block.task_text").addClass("blur");        
            jQuery("header.shokse-header").addClass("blur");        
        }

        function removeMainBlur()   {
            jQuery("header.shokse-header").removeClass("blur");     
            jQuery("main.block.task_text").removeClass("blur");           
        }
